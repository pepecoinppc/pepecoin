...
space *do not upload these to the getpepecoin.com server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the getpepecoin.com Github repo

- Create a [new GitHub release](https://github.com/pepecoinppc/pepecoin/releases/new) with a link to the archived release notes.

- Update getpepecoin.com version - Langerhans to do
