...
void Shutdown()
{
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // Pepecoin 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/pepecoinppc/pepecoin>";
    const std::string URL_WEBSITE = "<https://getpepecoin.com>";
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // Pepecoin: Do we need to do any RPC mining init here?
