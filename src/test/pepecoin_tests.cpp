...
BOOST_AUTO_TEST_CASE(hardfork_parameters)
{
    ...
    const Consensus::Params& digishieldParamsEnd = Params().GetConsensus(36999);
    ...
    const Consensus::Params& auxpowParams = Params().GetConsensus(37000);//PEPE TODO Magic number
    BOOST_CHECK_EQUAL(auxpowParams.nHeightEffective, 37000);//PEPE TODO Magic number
