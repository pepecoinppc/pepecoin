...
class GetCoinCountTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        result = node.getcoincount(145001)
        assert_equal(result, (145000 * 500000) + (1 * 250000))

        result = node.getcoincount(200001)
        assert_equal(result, (145000 * 500000) + (55000 * 250000) + (1 * 125000))

        result = node.getcoincount(300001)
        assert_equal(result, (145000 * 500000) + (55000 * 250000) + (100000 * 125000) + (1 * 62500))

        result = node.getcoincount(400001)
        assert_equal(result, (145000 * 500000) + (55000 * 250000) + (100000 * 125000) + (100000 * 62500) + (1 * 31250))

        result = node.getcoincount(500001)
        assert_equal(result, (145000 * 500000) + (55000 * 250000) + (100000 * 125000)
